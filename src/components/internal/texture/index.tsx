...
const MainHeading: React.FC<MainHeadingProps> = ({
  ...
  const Item = (
    <div className="">
      {title && (
        <p className="text-[#c5a059] font-bold uppercase tracking-[0.3em] mb-4">
          {title}
        </p>
      )}
      {description && (
        <h3 className="text-3xl font-serif text-[#1a1c1e] mb-12">
          {description}
        </h3>
      )}
    </div>
...
const TitleHeading: React.FC<MainHeadingProps> = ({
  ...
  const Item = (
    <div className="">
      {title && (
        <p className="text-[#c5a059] font-bold uppercase tracking-[0.2em] mb-4">
          {title}
        </p>
      )}
      {description && (
