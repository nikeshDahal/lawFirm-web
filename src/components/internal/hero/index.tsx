    ...
    <main className="relative h-[80vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-20 text-center px-6">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <button className="bg-[#c5a059] text-white px-8 py-4 rounded font-bold hover:bg-[#b08d4a] transition-colors uppercase tracking-wider text-sm">
            Our Practice Areas
          </button>
          <button className="bg-white/10 backdrop-blur-md border border-white/20 text-white px-8 py-4 rounded font-bold hover:bg-white/20 transition-colors uppercase tracking-wider text-sm">
            Meet Our Team
          </button>
        </div>
      </div>
