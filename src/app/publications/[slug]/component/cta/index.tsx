  ...
  return (
    <>
      <section className="my-20 p-10 bg-primary rounded-3xl text-white flex flex-col md:flex-row items-center justify-between gap-8 relative overflow-hidden group">
        ...
        <button className="relative z-10 bg-gradient-gold text-[#1a1c1e] px-8 py-4 rounded-xl font-black text-xs uppercase tracking-widest flex items-center gap-3 hover:bg-white transition-all shadow-xl active:scale-95">
